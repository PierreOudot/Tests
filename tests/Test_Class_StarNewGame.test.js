...
const spy2 = vi.spyOn(exports, 'guessPool','get');
...
describe('when max guessPoolLength if 2', () => {
    beforeEach(() => {
        spy2.mockClear().mockReturnValue(
            [
                {wordToGuess : "toto", question: "question", clue: "clue"},
                {wordToGuess: "tutu", question: "question2", clue: "clue2"}
            ]
        );
    });
...
describe('when objectToGuess.wordToGuess is toto', () => {
    ...
    let mockWordToChar = wordToCharArray("toto");
